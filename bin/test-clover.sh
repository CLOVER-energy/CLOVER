...
ython3.7 -m black src/clover || python3.9 -m black src/clover
...
python3.7 -m yamllint -c .yamllint-config.yaml locations/
echo -e "\e[1mYamllint done, see above for details...\e[0m"
echo -e "\e[1mRunning pytest...\e[0m"
ython3.7 -m pytest src/clover || python3.9 -m pytest src/clover
