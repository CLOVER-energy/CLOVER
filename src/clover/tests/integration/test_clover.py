...
class SimulationTests(_BaseTest):  # pylint: disable=too-many-public-methods
    ...
    def _check_output(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        diesel_times: float,
        final_pv_sizes: float,
        final_storage_size: float,
        initial_pv_sizes: float,
        ...
        self.assertEqual(
            info_file_data["simulation_1"]["final_pv_sizes"], final_pv_sizes
        )
        self.assertEqual(
            info_file_data["simulation_1"]["initial_pv_sizes"], initial_pv_sizes
        )
    ...
    def test_grid_prioritise_diesel_grid_pv_and_storage(self):
        ...
        self._check_output(
            ...
            diesel_capacity=0.0,
            diesel_times=0.0,
            final_pv_sizes={DEFAULT_PV_PANEL_NAME: 19.0},
            final_storage_size=21.34,
            initial_pv_sizes={DEFAULT_PV_PANEL_NAME: 20.0},
    ...
    def test_grid_prioritise_diesel_grid_and_storage(self):
        ...
        self._check_output(
            ...
            diesel_capacity=3.0,
            diesel_times=0.511,
            final_pv_sizes={DEFAULT_PV_PANEL_NAME: 0.0},
            final_storage_size=24.997,
            initial_pv_sizes={DEFAULT_PV_PANEL_NAME: 0.0},
            initial_storage_size=25.0,
            lcue=0.628,
