...
# Grid inputs file:
#   The relative path to the optimisation-input information file.
GRID_INPUTS_FILE: str = os.path.join("grid", "grid_inputs.yaml")
...
# Parse the grid input information.
    ...
    #     raise InputFileError(
    #         "grid inputs", "Grid inputs is not of type `dict`."
    #     )
    # try:
    #     grid_parameters = GridParameters.from_dict(
    #         list(converters.values()), logger, grid_inputs
    #     )
    # except Exception as e:
    #     logger.error(
    #         "%sAn error occurred parsing the grid inputs file: %s%s",
    #         BColours.fail,
    #         str(e),
    #         BColours.endc,
    #     )
    ...
    # try:
    #     grids: List[Grid] = [
    #         Grid.from_dict(logger, entry, scenarios)
    #         for entry in grid_inputs[GRIDS]
    #     ]
    # except Exception as e:
    #     logger.error(
    #         "%sError generating grids from inputs file: %s%s",
    #         BColours.fail,
    #         str(e),
    #         BColours.endc,
    #     )
    #     raise
    # logger.info("Grids file successfully parsed.")
