...
def plot_outputs(  # pylint: disable=too-many-locals, too-many-statements
    ...
    with tqdm(
        ...
        heatmap.figure.axes[-1].yaxis.label.set_size(7)
        heatmap.collections[0].colorbar.ax.tick_params(labelsize=7)
        axis.set_xlabel("Hour of day", fontsize=7)
        axis.set_ylabel("Day of year", fontsize=7)
        ...
        axis.set_xlabel("Hour of day", fontsize=7)
        axis.set_ylabel("Day of year", fontsize=7)
        plt.title("Output per kWp of solar capacity", fontsize=7)
        plt.xticks(rotation=0)
        plt.tight_layout()
        plt.savefig(
            os.path.join(figures_directory, "solar_output_hetamap_zoomed_titled.png"),
            bbox_inches="tight",
            pad_inches=0.05,
            transparent=True,
        )
        plt.savefig(
            os.path.join(figures_directory, "solar_output_hetamap_zoomed_titled.pdf"),
            bbox_inches="tight",
            pad_inches=0.05,
        )
        plt.close()
        ...
        plt.xlabel("Day of year", fontsize=7)
        plt.ylabel("PV Energy generation / kWh per day", fontsize=7)
        (axis := plt.gca()).tick_params(axis="both", which="major", labelsize=7)
        ...
        # plt.title("Daily energy generation of 1 kWp of solar capacity")
        plt.savefig(
            os.path.join(figures_directory, "solar_output_yearly_zoomed.png"),
            bbox_inches="tight",
            pad_inches=0.05,
            transparent=True,
        )
        plt.savefig(
            os.path.join(figures_directory, "solar_output_yearly_zoomed.pdf"),
            bbox_inches="tight",
            pad_inches=0.05,
        )
        plt.close()
        ...
        if grid_profile is not None:
            ...
            axis.set_xlabel("Hour of day", fontsize=7)
            axis.set_ylabel("Day of year", fontsize=7)
            plt.title("Grid availability of the selected profile", fontsize=7)
            plt.xticks(rotation=0)
            plt.tight_layout()
            plt.savefig(
                os.path.join(
                    figures_directory, "grid_availability_heatmap_zoomed_titled.png"
                ),
                pad_inches=0.05,
                transparent=True,
            )
            plt.savefig(
                os.path.join(
                    figures_directory, "grid_availability_heatmap_zoomed_titled.pdf"
                ),
                pad_inches=0.05,
            )
            plt.close()
            ...
            plt.xlabel("Hour of day", fontsize=7)
            plt.ylabel("Probability", fontsize=7)
            plt.title("Probability of grid electricity being available", fontsize=7)
            plt.savefig(
                os.path.join(
                    figures_directory,
                    "grid_availability_randomisation_comparison_zoomed_titled.png",
                ),
                pad_inches=0.05,
                transparent=True,
            )
            plt.savefig(
                os.path.join(
                    figures_directory,
                    "grid_availability_randomisation_comparison_zoomed_titled.pdf",
                ),
                pad_inches=0.05,
            )
            plt.close()
        ...
        fig, ax = plt.subplots(figsize=(183 * MM, 122 * MM))
        ...
        plt.savefig(
            os.path.join(figures_directory, "electric_device_loads_zoomed.png"),
            bbox_inches="tight",
            pad_inches=0.05,
            transparent=True,
        )
        plt.savefig(
            os.path.join(figures_directory, "electric_device_loads_zoomed.pdf"),
            bbox_inches="tight",
            pad_inches=0.05,
        )
        plt.close()
        ...
        ax.set_xlabel("Month of year", fontsize=7)
        ax.set_ylabel("Device load / W", fontsize=7)
        ax.tick_params(axis="both", which="major", labelsize=7)
        ...
        ax.yaxis.get_offset_text().set_fontsize(7)
        # ax.set_title("Electric load of each device")
        ax.legend(fontsize=7, ncols=len(initial_electric_monthly_sums) // 10 + 1)
        plt.savefig(
            os.path.join(figures_directory, "electric_device_loads_monthly_zoomed.png"),
            bbox_inches="tight",
            pad_inches=0.05,
            transparent=True,
        )
        plt.savefig(
            os.path.join(figures_directory, "electric_device_loads_monthly_zoomed.pdf"),
            bbox_inches="tight",
            pad_inches=0.05,
        )
        plt.close()
        ...
        ax.legend(fontsize=7, ncols=len(initial_electric_monthly_sums) // 10 + 1)
        plt.savefig(
            os.path.join(figures_directory, "electric_device_loads_average_zoomed.png"),
            bbox_inches="tight",
            pad_inches=0.05,
            transparent=True,
        )
        plt.savefig(
            os.path.join(figures_directory, "electric_device_loads_average_zoomed.pdf"),
            bbox_inches="tight",
            pad_inches=0.05,
        )
        plt.close()
        ...
        plt.xlabel("Hour of simulation", fontsize=7)
        plt.ylabel("Electric power demand / kW", fontsize=7)
        ...
        # plt.title(f"Load profile of the community for the first {CUT_OFF_TIME} hours")
        plt.savefig(
            os.path.join(figures_directory, "electric_demands_zoomed.png"),
            bbox_inches="tight",
            pad_inches=0.05,
            transparent=True,
        )
        plt.savefig(
            os.path.join(figures_directory, "electric_demands_zoomed.pdf"),
            bbox_inches="tight",
            pad_inches=0.05,
        )
        plt.close()
        ...
        # )
        plt.savefig(
            os.path.join(figures_directory, "electric_demands_yearly_zoomed.png"),
            bbox_inches="tight",
            pad_inches=0.05,
            transparent=True,
        )
        plt.savefig(
            os.path.join(figures_directory, "electric_demands_yearly_zoomed.pdf"),
            bbox_inches="tight",
            pad_inches=0.05,
        )
        plt.close()
        ...
        ax.set_xlabel("Hour of simulation", fontsize=7)
        ax.set_ylabel("Electric power demand / kW", fontsize=7)
        # ax.set_title(
        #     "Average load profile of the community during the first simulation year"
        # )
        ax.legend(fontsize=7)
        ...
        plt.savefig(
            os.path.join(
                figures_directory, "electric_device_loads_average_bar_zoomed.png"
            ),
            bbox_inches="tight",
            pad_inches=0.05,
            transparent=True,
        ...
        plt.savefig(
            os.path.join(
                figures_directory, "electric_device_loads_average_bar_zoomed.pdf"
            ),
            bbox_inches="tight",
            pad_inches=0.05,
        )
        ...
        fig, axis = plt.subplots(1, 2, figsize=(183 * MM, 122 * MM))
        ...
        plt.close()
        fig, axis = plt.subplots(1, 2, figsize=(90 * MM, 60 * MM))
        axis[0].plot(
            range(365),
            pd.DataFrame(domestic_demand).rolling(5).mean(),
            label=DemandType.DOMESTIC.value.capitalize(),
        ...
        plt.savefig(
            os.path.join(
                figures_directory, "electric_demand_annual_variation_zoomed.png"
            ),
            bbox_inches="tight",
            pad_inches=0.05,
            transparent=True,
        ...
        plt.savefig(
            os.path.join(
                figures_directory, "electric_demand_annual_variation_zoomed.pdf"
            ),
            bbox_inches="tight",
            pad_inches=0.05,
        )
        ...
        plt.xlabel("Day of simulation period", fontsize=7)
        plt.ylabel("Load / kWh/day", fontsize=7)
        ...
        plt.savefig(
            os.path.join(
                figures_directory, "electric_demand_total_annual_variation_zoomed.png"
            ),
            bbox_inches="tight",
            pad_inches=0.05,
            transparent=True,
        ...
        plt.savefig(
            os.path.join(
                figures_directory, "electric_demand_total_annual_variation_zoomed.pdf"
            ),
            bbox_inches="tight",
            pad_inches=0.05,
        )
        ...
        plt.xlabel("Year of investigation period", fontsize=7)
        plt.ylabel("Energy demand / MWh/year", fontsize=7)
        plt.gca().tick_params(axis="both", which="major", labelsize=7)
        ...
        # plt.title("Load growth of the community")
        plt.savefig(
            os.path.join(figures_directory, "electric_load_growth_zoomed.png"),
            bbox_inches="tight",
            pad_inches=0.05,
            transparent=True,
        )
        plt.savefig(
            os.path.join(figures_directory, "electric_load_growth_zoomed.pdf"),
            bbox_inches="tight",
            pad_inches=0.05,
        )
        plt.close()
        ...
        plt.savefig(
            os.path.join(
                figures_directory, "electricity_use_on_average_day_zoomed.png"
            ),
            bbox_inches="tight",
            pad_inches=0.05,
            transparent=True,
        ...
        plt.savefig(
            os.path.join(
                figures_directory, "electricity_availability_on_average_day_zoomed.png"
            ),
            bbox_inches="tight",
            pad_inches=0.05,
            transparent=True,
        ...
        plt.savefig(
            os.path.join(
                figures_directory, "electricity_availability_on_average_day_zoomed.pdf"
            ),
            bbox_inches="tight",
            pad_inches=0.05,
        )
        ...
        fig, ([ax1, ax2], [ax3, ax4]) = plt.subplots(
            2, 2, figsize=(183 * MM, 122 * MM)
        )  # ,sharex=True, sharey=True)
        heatmap = sns.heatmap(
            renewable_energy,
            vmin=0.0,
            vmax=max_value,
            cmap=sns.blend_palette(["white", "C3"]),
            cbar=True,
            ax=ax1,
        )
        heatmap.figure.axes[-1].yaxis.label.set_size(7)
        ...
        ax1.set_xlabel("Hour of day", fontsize=7)
        ax1.set_ylabel("Day of year", fontsize=7)
        ax1.set_title("Renewables", fontsize=7)
        ax1.tick_params(axis="both", which="major", labelsize=7)
        heatmap = sns.heatmap(
            storage_energy,
            vmin=0.0,
            vmax=max_value,
            cmap=sns.blend_palette(["white", "C2"]),
            cbar=True,
            ax=ax2,
        )
        heatmap.figure.axes[-1].yaxis.label.set_size(7)
        ...
        ax2.set_ylabel("Day of year", fontsize=7)
        ax2.set_title("Storage", fontsize=7)
        ax2.tick_params(axis="both", which="major", labelsize=7)
        heatmap = sns.heatmap(
            grid_energy,
            vmin=0.0,
            vmax=max_value,
            cmap=sns.blend_palette(["white", "C0"]),
            cbar=True,
            ax=ax3,
        )
        heatmap.figure.axes[-1].yaxis.label.set_size(7)
        ...
        ax3.set_xlabel("Hour of day", fontsize=7)
        ax3.set_ylabel("Day of year", fontsize=7)
        ax3.set_title("Grid", fontsize=7)
        ax3.tick_params(axis="both", which="major", labelsize=7)
        heatmap = sns.heatmap(
            diesel_energy,
            vmin=0.0,
            vmax=max_value,
            cmap=sns.blend_palette(["white", "C6"]),
            cbar=True,
            ax=ax4,
        )
        heatmap.figure.axes[-1].yaxis.label.set_size(7)
        ...
        if initial_cw_hourly_loads is not None:
            ...
            if cw_pvt:
                ...
                fig, ax1 = plt.subplots(figsize=(183 * MM, 122 * MM))
